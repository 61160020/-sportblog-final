...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
  <div class="container">
   ...
   <center>
    ...
    <form action="save_edit.php" method="post" name="registform" enctype="multipart/form-data" onSubmit="return formValidation();">
            ...
            <div class="form-group">
              <div class="form-row">
                <label class="control-label col-sm-5" for="name">ชื่อ-นามสกุล : </label>
                  <div class="col-sm-5">
                    <input type="text" class="form-control" name="name" placeholder="Name" id="name" maxlength="45" value="<?php echo $row->name;?>">
                  </div>
              </div>
            </div>
            <div class="form-group">
              <div class="form-row">
                <label class="control-label col-sm-5" for="penname">นามปากกา : </label>
                  <div class="col-sm-5">
                    <input type="text" class="form-control" name="penname" placeholder="Penname" id="penname" maxlength="45" value="<?php echo $row->penname;?>">
                  </div>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="control-label col-sm-5" ></label>
                  ...
                  <a href="changepass.php?id=<?php echo $_SESSION['authors_id'] ?>" class="button" >เปลี่ยนรหัสผ่าน</a>
              </div>
            </div>
            </form>
